...
describe("parse basic key values",function(){
  ...
  it("parse when there are leading spaces before key",function(){
    ...
    assert.ownInclude(kvParser.parse(" key=value"),expected);
  });
...
describe("error handling",function(){
  ...
  it("throws error on missing value when value is unquoted",function(){
    let errorValidator=errorChecker("key",3,MissingValueError);
    let expected=()=>{
      try {
        let p=kvParser.parse("key=");
      } catch (e) {
  ...
  it("throws error on missing value when value is quoted",function(){
    let errorValidator=errorChecker("key",9,MissingEndQuoteError);
    let expected=()=>{
      try {
        let p=kvParser.parse("key=\"value");
      } catch (e) {
        return errorValidator(e);
      }
    }
  ...
  it("throws error on missing key",function(){
    let errorValidator=errorChecker(undefined,0,MissingKeyError);
    let expected=()=>{
      try {
  ...
  it("throws error on missing assignment operator",function(){
    let errorValidator=errorChecker(undefined,4,MissingAssignmentOperatorError)
    let expected=()=>{
      try {
  ...
  it("throws error on incomplete key value pair",function(){
    let errorValidator=errorChecker(undefined,2,IncompleteKeyValuePairError)
    let expected=()=>{
      try {
